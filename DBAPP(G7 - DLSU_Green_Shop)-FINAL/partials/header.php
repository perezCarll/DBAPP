...
<main class="flex-fill">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="cartDrawer" aria-labelledby="cartDrawerLabel">
    ...
    <div class="offcanvas-body d-flex flex-column">
      <ul class="list-group list-group-flush flex-grow-1 mb-3" id="cartItems">
      ...
      <div class="border-top pt-3 small">
        ...
        <?php else: ?>
          <!-- Not logged in / not a customer: send to login -->
          <a href="/pages/admin-login.php?denied=1"
        ...
        <p class="text-muted mb-0">
          <small>Items are saved in your browser until you complete checkout.</small>
        </p>
      </div>
    </div>
  </div>
