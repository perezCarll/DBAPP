...
<section class="py-5" id="checkout">
  <div class="container">
    ...
    <form method="post" action="/auth/checkout-submit.php" id="checkoutForm">
      ...
      <input type="hidden" name="currency_code" id="checkoutCurrencyCode">
        ...
        <div class="col-lg-7">
            ...
            <div class="card-body">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <select id="checkoutBranch" name="branch" class="form-select form-select-sm">
          ...
          <div class="card mb-3">
            <div class="card-body">
              ...
              <p class="text-muted small mb-3">
                For now this is for record-keeping; actual payment can be handled on pick-up or via your chosen channel.
              </p>
              <div class="row g-3">
                <div class="col-md-6">
                  <label class="form-label small">Payment option</label>
                  <select id="checkoutPaymentMethod" name="payment_method" class="form-select form-select-sm">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text"
                         ...
                         class="form-control"
                         placeholder="GCash ref # / last 4 digits">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="alert alert-info small">
            ...
            and deducts stock using your MySQL triggers. You can extend it later for email
            notifications or payment integration.
          </div>
        </div>
            ...
            <div class="card-body">
              ...
              <ul class="list-group list-group-flush small mb-3" id="checkoutItems">
                <li class="list-group-item text-muted text-center" id="checkoutEmpty">
                  Your cart is empty. Go back to <a href="/pages/products.php">Products</a> to add items.
                </li>
              </ul>
