  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item"><a class="nav-link<?= ($_SERVER['PHP_SELF']==='/index.php'?' active':'') ?>" href="/index.php">Home</a></li>
        <li class="nav-item"><a class="nav-link<?= (str_contains($_SERVER['PHP_SELF'],'products')?' active':'') ?>" href="/pages/products.php">Products</a></li>
        <li class="nav-item"><a class="nav-link<?= (str_contains($_SERVER['PHP_SELF'],'branches')?' active':'') ?>" href="/pages/branches.php">Branches</a></li>
        <li class="nav-item"><a class="nav-link<?= (str_contains($_SERVER['PHP_SELF'],'about')?' active':'') ?>" href="/pages/about.php">About</a></li>
        <li class="nav-item"><a class="nav-link<?= (str_contains($_SERVER['PHP_SELF'],'contact')?' active':'') ?>" href="/pages/contact.php">Contact</a></li>
        <?php if (is_role(['Staff','Manager','Admin'])): ?>
          <li class="nav-item">
            <a class="nav-link<?= (str_contains($_SERVER['PHP_SELF'],'admin')?' active':'') ?>" href="/pages/admin.php">
      ...
      <div class="d-flex ms-lg-3 gap-2 align-items-center">
        ...
        <div class="dropdown">
          <button class="btn btn-outline-light dropdown-toggle" type="button" data-bs-toggle="dropdown" id="currencyBtn">
            <span class="currency-flag" id="currencyFlag"></span><span id="currencyLabel">PHP</span>
          </button>
        ...
        <?php else: ?>
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <?php if (is_role(['Staff','Manager','Admin'])): ?>
                <li><a class="dropdown-item" href="/pages/admin.php"><i class="bi bi-speedometer2 me-2"></i>Admin Panel</a></li>
                <li><hr class="dropdown-divider"></li>
              <?php endif; ?>
              <li>
                <form action="/auth/logout.php" method="post" class="px-3 py-1">
                  <button class="btn btn-link p-0"><i class="bi bi-box-arrow-right me-2"></i>Logout</button>
                </form>
              </li>
            </ul>
          </div>
...
<script>
  // add subtle shadow/darken on scroll
  (function () {
